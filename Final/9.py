...
def iteration(matrix, beta, field):
  ...
  capacity = beta**2 * 1 * np.var(energylist) / size**2
...
for (x,y),w in np.ndenumerate(A):  # adds squares piecewise
  color = 'black' if w == 1 else 'white'
  rect = plt.Rectangle([x, y], 1, 1, facecolor=color, edgecolor='midnightblue')
  ax.add_patch(rect)

ax.autoscale_view()
ax.invert_yaxis()
pl.title('Lattice $T=1$')
...
for (x,y),w in np.ndenumerate(A):  # adds squares piecewise
  color = 'black' if w == 1 else 'white'
  rect = plt.Rectangle([x, y], 1, 1, facecolor=color, edgecolor='blue')
  ax.add_patch(rect)

ax.autoscale_view()
ax.invert_yaxis()
pl.title('Lattice $T=2$')
...
for (x,y),w in np.ndenumerate(A):  # adds squares piecewise
  color = 'black' if w == 1 else 'white'
  rect = plt.Rectangle([x, y], 1, 1, facecolor=color, edgecolor='mediumslateblue')
  ax.add_patch(rect)

ax.autoscale_view()
ax.invert_yaxis()
pl.title('Lattice $T=3$')
...
for (x,y),w in np.ndenumerate(A):  # adds squares piecewise
  color = 'black' if w == 1 else 'white'
  rect = plt.Rectangle([x, y], 1, 1, facecolor=color, edgecolor='darkviolet')
  ax.add_patch(rect)

ax.autoscale_view()
ax.invert_yaxis()
pl.title('Lattice $T=4$')
...
for (x,y),w in np.ndenumerate(A):  # adds squares piecewise
  color = 'black' if w == 1 else 'white'
  rect = plt.Rectangle([x, y], 1, 1, facecolor=color, edgecolor='deeppink')
  ax.add_patch(rect)

ax.autoscale_view()
ax.invert_yaxis()
pl.title('Lattice $T=5$')
...
for (x,y),w in np.ndenumerate(A):  # adds squares piecewise
  color = 'black' if w == 1 else 'white'
  rect = plt.Rectangle([x, y], 1, 1, facecolor=color, edgecolor='crimson')
  ax.add_patch(rect)

ax.autoscale_view()
ax.invert_yaxis()
pl.title('Lattice $T=6$')
