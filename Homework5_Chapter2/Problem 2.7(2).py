...
class flying_cannon:
    ...
    Question 2.7
    """
    def __init__(self,angle = 3.14/4 , velocity = 700,location_x = 0, location_y = 0, time_step = 0.001 , B_over_m = 0):
    ...
    def show_results(self):
        pl.plot(self.x, self.y, 'g', label='The trajectory of the cannon without wind drag')
        pl.xlim(0.0, 60000.0)
        pl.ylim(0.0, 20000.0)
        pl.xlabel('x ($m$)')
        pl.ylabel('y ($m$)')
