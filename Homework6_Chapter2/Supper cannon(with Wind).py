...
class super_cannon(object) : 
    def __init__(self, aim_x=float(input('coordinate x :')), aim_y=float(input('coordinate y :')), wind_velocity=float(input('Wind Velocity :')),  time_step = 0.01):        
        self.t = [0]
        self.dt = time_step
        self.g = 9.8 
        self.aimx = aim_x
    ...
    def scan_angle(self):
        ...
        pl.text(1000000,400000,'With Wind')
